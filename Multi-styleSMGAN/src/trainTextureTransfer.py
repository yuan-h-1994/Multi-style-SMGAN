    ...
    for epoch in range(opts.texture_step1_epochs):
        for i in range(opts.Ttraining_num//opts.batchsize):
            for j in range(opts.style_number):
                ...
                labels = label_input(label_name,opts.batchsize//4, opts.gpu)
                ...
                x, y = cropping_training_batches(X, Y, Noise, opts.batchsize//4, 
            ...
            losses = netShapeM.texture_one_pass(xm, ym, labelm)
