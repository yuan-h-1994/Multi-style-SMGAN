...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--label_nc', type=int, default=3, help='# of input label classes without unknown class.')
...
class TrainShapeMatchingOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--style_number', type=str, default=4, help=' style image number')   
        # ouptput related
